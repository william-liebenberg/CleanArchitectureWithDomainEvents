...
namespace CleanArchitectureWithDomainEvents.WebApi.Filters;
...
public static class ExceptionFilter
{
    ...
    private static IResult HandleException(this HttpContext context, Exception exception)
    {
        ...
        // TODO: Testing around unhandled exceptions (https://github.com/SSWConsulting/CleanArchitectureWithDomainEvents/issues/80)
